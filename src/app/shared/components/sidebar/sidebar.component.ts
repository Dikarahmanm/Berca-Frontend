...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  // Convert to signals for OnPush reactivity
  ...
  handleLogout(): void { this.isLoggingOut.set(true); this.logoutClicked.emit(); setTimeout(() => { this.isLoggingOut.set(false); }, 5000); }
  ...
  updateNotificationCount(count: number): void { this.notificationCount = count; this.layoutService.updateNotificationBadge(count); this.navigationSections.set(this.layoutService.getNavigationForRole(this.role)); }
}
